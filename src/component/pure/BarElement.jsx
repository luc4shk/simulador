...
export default function BarElement({url, msg, seleccion, index, activo}) {
  ...
  return (
    <>
      <li onClick={()=>seleccion(index)} className={`hover:bg-selectOption transition-colors  ${activo ? "bg-selectOption border-l border-l-principal border-l-4" : activo}  w-full  h-11`}>
